(function ($) {
  $.fn.mdbRate = function (currentStars) {
    var $stars;
    ...
    for (var i = 0; i < 5; i++) {
      $container.append(`<i class="py-1 px-1 rate-popover" data-index="${i}" data-html="true" data-toggle="popover"
    ...
    if (currentStars) {
      markStarsAsActive(currentStars);
    }
